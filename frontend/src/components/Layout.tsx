...
import { Mic, FileText, LogIn, LogOut, User } from 'lucide-react';
            ...
            <nav className="flex gap-1 items-center">
              {user ? (
                <>
                  ...
                  <Link to="/history" className="flex items-center gap-1 text-slate-600 hover:text-blue-600 font-medium transition-colors">
